package com.vcc.adtech.demosimplecrub.layer.infrastucture.read;
...
@Configuration
public class JdbcMysqlReadAdapter {
    ...
    @Bean(name = "mysqlJdbcReadTemplate")
    @Autowired
    public JdbcTemplate mysqlLocalJdbcReadTemplate(@Qualifier("mysqlReadDataSource") DataSource dataSource) {
